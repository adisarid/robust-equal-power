...
% *** Presentation to internal seminar day (2-Jan-2017) ***
...
%\framesubtitle{Can this method converge in a resonable time frame? Depends.}
\footnotesize
Simple experiment
\begin{itemize}
...
%\begin{figure}[h]
%	\centering
%		\includegraphics[width=1\textwidth]{Aux_files/figure_6_opt_gap.pdf}
%	\label{fig:figure_6_opt_gap}
%\end{figure}
\begin{itemize}
...
%\begin{frame}
%\frametitle{Preliminary results}
%\framesubtitle{Can this method converge in a resonable time frame? Depends.}\footnotesize
%
%In the ``hard'' cases, a significant portion of the time is spent on simulations, not on branching\\
%
%\vspace{0.1in}
%
%\begin{figure}[h]
	%\centering
		%\includegraphics[width=1\textwidth]{Aux_files/figure_7_time_simulating.pdf}
	%\label{fig:figure_7_time_sim}
%\end{figure}
%\end{frame}

% Mostly talk about tractability - can this problem be solved? how does it depend on parametrization.
